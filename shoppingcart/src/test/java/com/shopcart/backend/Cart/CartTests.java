...
public class CartTests {
	...
	public void getCartItems() {
		...
		Mockito.when(cartRepository.findByCartitemIdAndUserId((long) 1, (long) 4)).thenReturn(Optional.of(cart));
...
//		Mockito.when(productsRepository.findById((long) 4)).thenReturn(Optional.of(products));
//		
//		HashMap<Long,Long> cart2 = cartServices.getTotalPrice((long) 4);
//		assertNotEquals(0,cart2.size());
//		
//	}
}
